...
export function Header() {
  ...
  return (
    <>
      <header
        className={`${isScrolled || isMobileMenuOpen ? "bg-slate-900 shadow-md" : "bg-transparent"
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <div className="flex space-x-2">
                ...
                <Button className="bg-orange-500 hover:bg-orange-600" onClick={() => setIsRegisterDialogOpen(true)}>
                  Cadastrar
                </Button>
              </div>
            </nav>
